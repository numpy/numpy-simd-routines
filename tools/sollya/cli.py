...
"""
            ...
            for line in process.stdout:
                fold = line.casefold()
                # treats warnings as errors to detect NaNs,
                # also some syntax errors are reported as warnings
                got_error = "warning" in fold or "error" in fold
                got_info = "information" in fold and not got_error
